...
if (!function_exists('sendSMS')) {
    function sendSMS($data, $remender)
    {
        $telefon = $data->phone;
        $msg = $remender->desc;
        $name = $remender->name;
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_POSTFIELDS => "{ \"messages\": [ { \"recipient\": \"$telefon\", \"message-id\": \"2016256\", \"sms\": { \"originator\": \"3700\", \"content\": { \"text\": \"$app_name , $name , $msg, $date\" } } } ] }",
